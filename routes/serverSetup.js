...
exports.run = async (req,res)=>{
    ...
    DB.serverDB.findOne({ id:SVID }).then(async serverData =>{
        ...
        res.render('procedures/serverSetup/main', {serverDataB64: toBase64(serverData),serverInfoB64: toBase64(serverInfo), serverData: serverData,serverInfo: serverInfo} );

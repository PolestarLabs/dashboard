...
router.get('/:serverID', async function (req,res) {
    ...
    let payload = {
        reactRoles,
        serverDataB64: toBase64(serverData),
        serverData: serverData,
        commands: fx.cmsSetup(req),
        langs: operations.getLangs(),
        memberInfoB64: toBase64(memberInfo),
        roleInfoB64: toBase64(roleInfo),
        serverInfoB64: toBase64(serverInfo),
        channelInfoB64: toBase64(channelInfo),
